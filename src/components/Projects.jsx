...
import js from "../assets/img/icons8-javascript (1).svg"
...
export const Projects = () => {
  ...
  const projects = [
    
    {
      ...
      TechStack:[{img:html,name:"html"},{img:css,name:"css"},{img:js,name:"js"},{img:bootstrap,name:"bootstrap"}],
  NamesofTechstack:["html","css","js","bootstrap"],
 ...
 AreasOfResponsibility:"Main Product Page,Stripe Api Integration and Authentication using Jwt and Nodemailer "
  ...
  const project1 = [
    {
      ...
      TechStack:[{img:html,name:"html"},{img:css,"name":"css"},{img:js,"name":"js"}],
  ...
  const project2 = [
    
    {
      ...
      TechStack:[{img:node,name:"node js"},{img:express,name:"express js"},{img:html,name:"html"},{img:css,name:"css"},{img:js,name:"js"}],
      NamesofTechstack:["node","express","html","css","js"],
      ProjectType:"A Collaborative Project Built by a team of four Full stack Devloper",
  ...
  const project3 = [
    
    {
      ...
      TechStack:[{"chakra ui":chakraui},{"react js":react},{"node js":node},{"express js":express},{"mongodb":mongodb}],
      ProjectType:"Individual Project",
  ...
  const project4 = [
    
    {
      ...
      NamesofTechstack:["node js","express js","mongodb","passport js"],
      ProjectType:"Individual Project",
