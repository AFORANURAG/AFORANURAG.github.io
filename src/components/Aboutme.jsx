...
export default function Aboutme() {
  return (
    <Container id="aboutme" className="aboutme" style={{width:"100%",marginTop:"50px",marginBottom:"100px",borderRadius:"3%",height:"auto",textAlign:"center"}}>
